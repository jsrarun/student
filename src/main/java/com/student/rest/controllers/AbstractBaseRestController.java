...
public abstract class AbstractBaseRestController<E extends IdentityModel, Q extends RestResponse, S extends Service<E, Q, R>, R extends Repository<E, Q>>
    implements RestController<E, Q, S, R> {
